...
public class CalendarActivity extends AppCompatActivity {
    ...
    public static final String TEXT_TANGGAL = "sharedTanggal";
    ...
    public void pesanTanggal(String pesan)
    {
        ...
        Toast.makeText(this, "TEXT_TANGGAL : " + sharedPreferences.getString(CalendarActivity.TEXT_TANGGAL, ""), Toast.LENGTH_SHORT);
